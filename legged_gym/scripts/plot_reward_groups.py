...
def main():
    ...
    parser.add_argument("--drift_root", type=Path, default=Path("results/a1/Drift"))
    parser.add_argument("--ppo_root", type=Path, default=Path("results/a1/PPO"))
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("results/a1/reward_curve_comparison"))
