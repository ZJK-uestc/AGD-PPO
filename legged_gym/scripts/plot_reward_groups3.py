...
def main():
    ...
    parser.add_argument("--drift_root", type=Path, default=Path("results/cassie/Drift"))
    parser.add_argument("--ppo_root", type=Path, default=Path("results/cassie/PPO"))
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("results/cassie/reward_curve_comparison"))
